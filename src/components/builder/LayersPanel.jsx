...
import { Type, ImageIcon, Square, Layout, Edit2, Lock, X, AlertTriangle } from 'lucide-react';
...
function LayerRow({ el, isSelected, onSelect, onDelete, componentSettings }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: 'pointer',
        background: isSelected ? 'var(--cream2)' : hovered ? 'var(--cream)' : 'white',
    ...
    >
      ...
      {hovered ? (
        ...
        willBeDisabled
          ? <AlertTriangle size={14} color="#E65100" style={{ flexShrink: 0, marginTop: 1 }} />
          : isEditable
